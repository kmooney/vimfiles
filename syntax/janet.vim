...
let s:janet_syntax_keywords = {
    ...
    \ , 'JanetMacro': ["%=","*=","++","+=","--","-=","->","->>","-?>","-?>>","/=","and","as->","as-macro","as?->","assert","case","chr","comment","compif","comptime","compwhen","cond","coro","def-","default","defdyn","defer","defmacro","defmacro-","defn","defn-","delay","doc","each","eachk","eachp","edefer","ev/do-thread","ev/gather","ev/spawn","ev/spawn-thread","ev/with-deadline","fiber-fn","for","forever","forv","generate","if-let","if-not","if-with","import","juxt","label","let","loop","match","or","prompt","protect","repeat","seq","short-fn","tracev","try","unless","use","var-","varfn","when","when-let","when-with","with","with-dyns","with-syms","with-vars"]
    \ }
